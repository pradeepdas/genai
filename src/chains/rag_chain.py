...
from src.chains.basic_chain import basic_chain, get_model
from src.loaders.remote.remote_loader import lc_get_wiki_docs
...
def main():
    ...
    docs = lc_get_wiki_docs(query="Bertrand Russell")
